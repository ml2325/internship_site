...
if(isset($_POST['search']))
{
    ...
    OR `email` LIKE '%".$valueToSearch."%' OR `pass` LIKE '%".$valueToSearch."%' OR `school` LIKE '%".$valueToSearch."%' OR `promotions` LIKE '%".$valueToSearch."%' )
    AND `user` = 'student';
    ";
...
<body>
    ...
    <nav>
        <h1>Gestion Students</h1>
    </nav>
    
        
            <div class="middle">
            <h3 style="margin-top:4rem;">Filter Students</h3>
    ...
    <?php @include 'pilot_header.php';?>
        ...
        <form action="filter_pilot_students.php" method="post">
            ...
            <a href="pilot_students.php" class="btn btn-dark mb-3">Go Back</a>
