...
if(isset($_POST['submit'])){
    ...
    $assigned_promo=$_POST['assigned_promo'];
    $sql="UPDATE `users` SET `username`='$username',`email`='$email',`pass`='$pass',`school`='$school',`user`='$user',`promotions`='$promotions',`assigned_promo`='$assigned_promo' WHERE id=$id";
        ...
        <div class="container d-flex justify-content-center">
            ...
            <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="assigned_promo" value="<?php echo $row['assigned_promo']?>">
                </div>
